...
import com.VisionZar.employeeManagement.config.DataSourceUtility;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.VisionZar.employeeManagement.persistence"}, transactionManagerRef = "transactionManager")
@ComponentScan(basePackages = "com.VisionZar.employeeManagement.service")
...
public class TestDataSourceConfiguration {
  @Bean(name = "localContainerEntityManagerFactoryBean")
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.VisionZar.employeeManagement.domain");
